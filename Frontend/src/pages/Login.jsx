...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const raw = error?.detail || error?.message || error;
        ...
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-4 lg:p-8">
          ...
          <form onSubmit={handleSubmit} className="p-2 space-y-6">
            ...
            <button
              ...
              disabled={loading}
              className={`w-full bg-gradient-to-r from-blue-600 to-blue-400 text-white py-3 rounded-xl font-semibold flex items-center justify-center gap-2 hover:shadow-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all ${clicked === "Sign" && !loading ? "scale-105" : "scale-100"
                }`}
            >
              {loading ? (
