...
export default function Bills() {
  ...
  const [SelectedAccount, setSelectedAccount] = useState(localStorage.getItem("selected_account_id") || null);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {bills.length === 0 ? (
          <div className="bg-white rounded-2xl p-12 text-center shadow-lg">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">No bills yet. Add your first bill.</h3>
          </div>
        ) : (
